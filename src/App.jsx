...
function App() {
  ...
  return <AssessmentPortfolio onBackHome={() => setView("home")} />;
}

function AssessmentPortfolio({ onBackHome, onGoCV }) {
  const chapters = useMemo(
    () => [
      { id: "ch1", title: "Employability Skills", body: sampleIntro },
      { id: "ch2", title: "Emotional Intelligence", body: "/" },
      { id: "ch3", title: "Portfolio Writing", body: "/" },
      { id: "ch4", title: "CV Writing", body: "/" },
      { id: "ch5", title: "Interview Skills", body: "/" },
      { id: "ch6", title: "Dining Etiquettes", body: "/" },
      { id: "ch7", title: "Grooming Etiquettes", body: "/" },
      { id: "ch8", title: "Negotiation Skills", body: "/" },
      { id: "ch9", title: "Code of Ethics in IT", body: "/" },
    ],
    [],
  );
  ...
  useEffect(() => {
    ...
    chapters.forEach(
      (c) =>
        sectionRefs.current[c.id] && obs.observe(sectionRefs.current[c.id]),
    );
            ...
            <div className="flex items-center gap-3">
              ...
              <div className="text-left">
                ...
                <p className="text-[10px] md:text-xs text-slate-300">
                  Scroll through each chapter to explore learnings, reflections
                  and activities.
                </p>
              </div>
            </div>
...
const sampleIntro = `Employability skills are the essential non-technical abilities that employers seek across all industries. They complement technical expertise and make you a well-rounded professional. This module explores how values, beliefs, and attitudes shape character and behaviour in professional life.`;
